...
echo "================================================================="
echo " Project Zomboid Build 42 Engine Optimizer (v0.9.7.8)"
...
EOF
    ...
    echo "{\"optimized\":true,\"ram_gb\":$ALLOC_RAM,\"g1gc\":true,\"pretouch\":true,\"version\":\"0.9.7.8\"}" > "$HOME/Zomboid/Lua/pzo_status.json"
