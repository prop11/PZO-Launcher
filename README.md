...
- **ZombieBuddy-Dependent Mods**: **Fully Supported from v0.4.4!** `PZOptimEngine.jar` features a built-in Java Mod Loader that automatically discovers, classloads, and hooks mods created for ZombieBuddy directly from your Workshop folders.
